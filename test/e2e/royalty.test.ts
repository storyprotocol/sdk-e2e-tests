...
import { registerIpAsset, mintLicenseTokens, attachLicenseTerms, registerDerivative, registerDerivativeWithLicenseTokens, registerCommercialUsePIL, registerCommercialRemixPIL, payRoyaltyOnBehalf, royaltySnapshot, collectRoyaltyTokens, royaltyClaimableRevenue } from '../../utils/sdkUtils'
...
describe('SDK E2E Test', function () {
    describe("Royalty", function () {
        ...
        describe('Pay Royalty On Behalf', async function () {
