...
import { registerCommercialUsePIL, registerIpAsset, attachLicenseTerms, mintLicenseTokens, registerDerivative, registerDerivativeWithLicenseTokens } from '../../utils/sdkUtils'
...
describe('SDK E2E Test', function () {
    describe("Register Derivative IP Asset with Commercial Use PIL", function () {
        ...
        describe('Register a derivative IP asset with multiple parent IP assets', async function () {
            ...
            step("Wallet B attach licenseTermsId1(commercial use PIL) to ipIdA", async function () {
                const response = await expect(
...
            });
        ...
        describe("Register a derivative IP assets with multiple license tokens", async function () {
            ...
            step("Wallet B attach licenseTermsId1(commercial use PIL) to ipIdB", async function () {
                const response = await expect(
                    attachLicenseTerms("B", ipIdB, licenseTermsId1, waitForTransaction)
                ).to.not.be.rejected;
